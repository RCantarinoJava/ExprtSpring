...
Brewer.ComboEstado = (function() {
	...
	ComboEstado.prototype.start = function() {
...
Brewer.ComboCidade = (function() {
	...
	function ComboCidade(comboEstado) {
		...
		this.inputHiddenCidadeSelecionada = $('#codCidadeSelecionada');
	}

	ComboCidade.prototype.start = function() {
		reset.call(this);
	...
	function onBuscarCidadesFinalizado(cidades) {
		...
		var codCidadeSeleciona = $('#codCidadeSelecionada').val();
		if (codCidadeSeleciona)
			this.combo.val(codCidadeSeleciona);
